            ...
            <Container>   
                <h1>Services</h1>
                    ...
                    <Row xs={2} md={4} className="g-4">
                        ...
                        {title:'Autres Services', image:require('../images/service.jpg'), description:'This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.'}
                        ].map((variant, idx) => (
                            <Col>
